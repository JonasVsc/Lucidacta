...
VkPipeline LucidCreatePipeline(VkDevice device, const LucidPipelineCreateInfo* createInfo)
{
	...
	VkShaderModule vertShaderModule = LucidCreateShaderModule(device, createInfo->vertShader);
	VkShaderModule fragShaderModule = LucidCreateShaderModule(device, createInfo->fragShader);
	...
	VkVertexInputBindingDescription inputBindingDescription[] = {
		{0, sizeof(LucidVertex), VK_VERTEX_INPUT_RATE_VERTEX}
	};
...
VkPipelineLayout LucidCreatePipelineLayout(VkDevice device)
{
	VkPushConstantRange bufferRange = {
		...
		.offset = 0,
		.size = sizeof(LucidPushConstants)
	};
