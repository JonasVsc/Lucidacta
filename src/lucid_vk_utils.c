...
VkDeviceMemory LucidAllocateMemory(VkPhysicalDevice physicalDevice, VkDevice device, VkBuffer buffer, VkMemoryPropertyFlags properties, VkMemoryAllocateFlags flags)
{
...
{
	size_t codeSize = {0};
	DWORD* pCode = LucidReadFile(path, &codeSize);
